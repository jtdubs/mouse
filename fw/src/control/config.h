...
constexpr float LINEAR_KP             = 0.1;                    // dimensionless
constexpr float LINEAR_KI             = 0.02 * CONTROL_PERIOD;  // dimensionless
constexpr float LINEAR_LOW_PASS_ALPHA = 0.5;                    // dimensionless
